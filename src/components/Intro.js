...
const Intro = () => {
  ...
  return (
    <div className="intro">
      ...
      <p>After gathering the lyrics, artists and peak positions of all 5000 top songs since 1970 I made an interactive tool to help others explore the data. Simply enter a word in the search bar and the chart will display how many songs each year contained that word. To explore further, click a year of the chart to see a list of each song then click a song to display the lyrics and usage of the word that was searched.</p>
    </div>
  )
}
